# -*- coding: utf-8 -*-
"""
Created on Sun Oct 21 01:43:46 2018
...
class Retrain_Tensorflow_Model():
    ...
    def __init__(self, image_dims, output_dims):
        ...
        self.__W = {
                1: tf.get_variable("w1", shape = [3, 3, 3, 8]),
                2: tf.get_variable("w2", shape = [3, 3, 8, 16]),
                3: tf.get_variable("w3", shape = [3, 3, 16, 32]),
                4: tf.get_variable("w4", shape = [3, 3, 32, 64]),
                5: tf.get_variable("w5", shape = [3, 3, 64, 128]),
                6: tf.get_variable("w6", shape = [3, 3, 128, 256]),
                7: tf.get_variable("w7", shape = [3, 3, 256, 512]),
                11: tf.get_variable("w11", shape = [3*4*128, 1024]),
                12: tf.get_variable("w12", shape = [1024, output_dims]),
            }
        
        self.__b = {
                1: tf.get_variable("b1", shape = [8]),
                2: tf.get_variable("b2", shape = [16]),
                3: tf.get_variable("b3", shape = [32]),
                4: tf.get_variable("b4", shape = [64]),
                5: tf.get_variable("b5", shape = [128]),
                6: tf.get_variable("b6", shape = [256]),
                7: tf.get_variable("b7", shape = [512]),
                11: tf.get_variable("b11", shape = [1024]),
                12: tf.get_variable("b12", shape = [output_dims]),
            }
