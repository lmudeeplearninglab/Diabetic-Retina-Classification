...
class readtestingimage():
    ...
    def __init__(self, batch_point, TRAIN_or_TEST):
       # self.argv = 
...
#            print("This image does not work")
    ...
    def image_batch_generator(self, array, batch_point, ext):
...
#          print("length of data is", len(array[0]))
          ...
          for i in range(batch_point, batch_point+100):              
              batch = array[0][i]                   
...
#              print("The batch is", batch)              
              ...
              data_batch.append((self.image_transformation(image_path), array[1][i], batch))
    ...
    def execute(self):
        ...
        self.get_daved_mean()
        training_batch_generator = self.image_batch_generator(self.train_image_names_with_labels, self.batch_point, self.EXT_TRAIN_DATA)
